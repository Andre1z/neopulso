...
class login : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //binding.btnAcerca.setOnClickListener { startActivity(Intent(this, AcercaDe::class.java)) } ** Solo Pruebas
        //binding.btnContacto.setOnClickListener { startActivity(Intent(this, Contacto::class.java)) } ** Solo Pruebas
    }
}